...
//		return "Course [courseid=" + courseid + ", classSize=" + classSize + ", courseDescription=" + courseDescription
//				+ ", courseName=" + courseName + ", credit=" + credit + ", endDate=" + endDate + ", endTime=" + endTime
//				+ ", examTime=" + examTime + ", numberRegistered=" + numberRegistered + ", startDate=" + startDate
//				+ ", startTime=" + startTime + ", weekday=" + weekday + ", user=" + user + ", studentEnrolments="
//				+ studentEnrolments + "]";
//	}
