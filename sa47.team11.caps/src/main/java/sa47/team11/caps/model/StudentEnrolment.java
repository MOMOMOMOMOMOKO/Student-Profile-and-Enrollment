...
//		return "StudentEnrolment [studentEnrolId=" + studentEnrolId + ", dateRegistered=" + dateRegistered + ", score="
//				+ score + ", statusEnroll=" + statusEnroll + ", course=" + course + ", user=" + user
//				+ ", getStudentEnrolId()=" + getStudentEnrolId() + ", getDateRegistered()=" + getDateRegistered()
//				+ ", getScore()=" + getScore() + ", getStatusEnroll()=" + getStatusEnroll() + ", getCourse()="
//				+ getCourse() + ", getUser()=" + getUser() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode()
